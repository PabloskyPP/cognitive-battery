...
class Ui_CognitiveBattery(object):
    ...
    def retranslateUi(self, CognitiveBattery):
        ...
        item.setText(_translate("CognitiveBattery", "Digits Memorization"))
        ...
        item.setText(_translate("CognitiveBattery", "D2"))
        item = self.taskList.item(11)
        item.setText(_translate("CognitiveBattery", "Dual Task"))
        item = self.taskList.item(12)
        item.setText(_translate("CognitiveBattery", "Relative Verticality Perception (PVR)"))
        item = self.taskList.item(13)
        item.setText(_translate("CognitiveBattery", "ACS"))
        item = self.taskList.item(14)
        item.setText(_translate("CognitiveBattery", "RIASEC"))
        item = self.taskList.item(15)
        item.setText(_translate("CognitiveBattery", "Inteligencia Multiple"))
        item = self.taskList.item(16)
        item.setText(_translate("CognitiveBattery", "SRQ20"))
        item = self.taskList.item(17)
        item.setText(_translate("CognitiveBattery", "Ikigai"))
        item = self.taskList.item(18)
        item.setText(_translate("CognitiveBattery", "FourFigures"))
        item = self.taskList.item(19)
        item.setText(_translate("CognitiveBattery", "NamingNumbers"))
