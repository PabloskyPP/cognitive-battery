...
class FiveDigits(object):
    ...
    # Fixed predefined sequence for part 1 (18 trials: 2 of each shape, all c)
    _PART1_SEQUENCE = ["7", "2", "9", "4", "1", "6", "8", "3", "5", "4", "8", "1", "9", "6", "2", "5", "7", "3"]

    # Fixed predefined sequence for part 2 (18 trials: 2 of each 4x4 contour-content pair)
    _PART2_SEQUENCE = [
    ...
    def run(self):
        ...
        self._show_text_screen(
            [
                "Esta prueba consta de 4 partes, en las que las instrucciones sobre el estímulo hacia el que la persona tiene que enfocar su atención y responder (puntos o agrupaciones de cifras) cambian en cada parte.",
                "",
        ...
        self._show_text_screen(
            [
                "Para cada estímulo tienes que indicar bien el número de cifras, o el nombre de las cifras presentadas, según por lo que se esté a preguntar en cada parte.",
                "",
                ...
                "",
                "Tienes que emitir tu respuesta de la forma más rápida y precisa posible.",
                "",
        ...
        self._show_practice_integrated_screen(
            instruction_lines=[
                "Primera parte",
                "",
                "En esta parte tienes que indicar el número de puntos que aparecen en cada caso.",
                "",
        ...
        self._show_practice_integrated_screen(
            instruction_lines=[
                ...
                "De nuevo, se van a mostrar agrupaciones de cifras.",
                "",
                "En esta parte final, empiezas indicando la cifra que se muestra. Sin embargo, de vez en cuando estas cifras se mostrarán en color rojo.",
                "",
                "Esto indica un cambio de objetivo para el caso rojo actual y en adelante hasta el siguiente caso rojo.",
                "",
                "Así por ejemplo, después del primer caso rojo y en este incluído, tienes que cambiar de indicar la cifra que aparece, al número de cifras que aparecen. Y así cambiando sucesivamente el objetivo de tu respuesta con cada caso rojo que aparezca.",
                "",
